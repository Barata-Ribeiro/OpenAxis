...
interface PaymentConditionServiceInterface
{
    /**
     * Retrieve a paginated list of payment conditions.
     *
     * Builds and returns a paginated collection of payment conditions using provided pagination,
     ...
     * @param  string|null  $search  Free-text search to filter payment conditions by name, code, or other searchable fields.
     ...
     * @return \Illuminate\Pagination\LengthAwarePaginator Paginated collection of payment conditions.
     */
