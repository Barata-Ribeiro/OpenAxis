...
'hashing.argon.verify','hashing.rehash_on_login','inertia.ssr.enabled','inertia.ssr.url','inertia.ensure_pages_exist',
...
'appearance.edit','two-factor.show','administrative.users.index','storage.local',);
