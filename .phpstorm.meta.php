...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app' => 'array',
            'app.Agent' => 'string',
            'app.bypass_concurrency.dashboard' => 'boolean',
...
'app.bypass_concurrency.dashboard','audit.enabled','audit.implementation','audit.user.morph_prefix','audit.user.guards',
...
'filesystems.disks.media.url','filesystems.disks.media.visibility','filesystems.disks.media.throw','filesystems.links.C:\\xampp\\htdocs\\openaxis\\public\\storage','fortify.guard',
...
'reverb.apps.apps.0.max_connections','reverb.apps.apps.0.max_message_size','services.postmark.key','services.resend.key','services.ses.key',
...
'debugbar.telescope','boost.browser-logs','login','login.store','logout',
...
'two-factor.regenerate-recovery-codes','telescope','home','dashboard','profile.edit',
'profile.update','profile.destroy','profile.notifications','profile.notifications.toggle-read','profile.notifications.destroy',
'profile.addresses','profile.addresses.store','profile.addresses.update','profile.addresses.set-primary','profile.addresses.destroy',
'user-password.edit','user-password.update','appearance.edit','two-factor.show','sessions.index',
...
'administrative.roles.edit','administrative.roles.update','administrative.roles.destroy','administrative.users.force-destroy','administrative.users.generate-csv',
...
'erp.categories.destroy','erp.products.force-destroy','erp.products.generate-csv','erp.products.index','erp.products.create',
'erp.products.store','erp.products.show','erp.products.edit','erp.products.update','erp.products.destroy',
'erp.inventory.generate-csv','erp.inventory.index','erp.inventory.create','erp.inventory.store','erp.inventory.show',
'erp.inventory.edit','erp.inventory.update','erp.inventory.destroy','erp.clients.force-destroy','erp.clients.generate-csv',
'erp.clients.index','erp.clients.create','erp.clients.store','erp.clients.show','erp.clients.edit',
'erp.clients.update','erp.clients.destroy','erp.purchase-orders.index','erp.purchase-orders.create','erp.purchase-orders.store',
'erp.purchase-orders.edit','erp.purchase-orders.update','erp.purchase-orders.destroy','erp.sales-orders.generate-csv','erp.sales-orders.index',
...
'erp.suppliers.destroy','erp.payables.generate-csv','erp.payables.index','erp.payables.create','erp.payables.store',
'erp.payables.show','erp.payables.edit','erp.payables.update','erp.payables.destroy','erp.receivables.generate-csv',
'erp.receivables.index','erp.receivables.create','erp.receivables.store','erp.receivables.show','erp.receivables.edit',
'erp.receivables.update','erp.receivables.destroy','erp.payment-conditions.index','erp.payment-conditions.create','erp.payment-conditions.store',
'erp.payment-conditions.edit','erp.payment-conditions.update','erp.payment-conditions.destroy','storage.local',);
...
'APP_ADMIN_EMAIL','APP_ADMIN_NAME','APP_ADMIN_PASSWORD','APP_BYPASS_CONCURRENCY_DASHBOARD','APP_TIMEZONE',
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER','PHP_CLI_SERVER_WORKERS',
'HASH_DRIVER','ARGON_MEMORY','ARGON_THREADS','ARGON_TIME','HASH_VERIFY',
...
'VITE_REVERB_APP_KEY','VITE_REVERB_HOST','VITE_REVERB_PORT','VITE_REVERB_SCHEME','DEBUGBAR_ENABLED',);
