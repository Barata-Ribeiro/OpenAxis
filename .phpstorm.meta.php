    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'App\Interfaces\Management\ClientServiceInterface' => \App\Services\Management\ClientService::class,
            'App\Interfaces\Management\PayableServiceInterface' => \App\Services\Management\PayableService::class,
            'App\Interfaces\Management\PaymentConditionServiceInterface' => \App\Services\Management\PaymentConditionService::class,
            'App\Interfaces\Management\PurchaseOrderServiceInterface' => \App\Services\Management\PurchaseOrderService::class,
            'App\Interfaces\Management\ReceivableServiceInterface' => \App\Services\Management\ReceivableService::class,
            'App\Interfaces\Management\SalesOrderServiceInterface' => \App\Services\Management\SalesOrderService::class,
            'App\Interfaces\Management\SupplierServiceInterface' => \App\Services\Management\SupplierService::class,
            'App\Interfaces\Management\VendorServiceInterface' => \App\Services\Management\VendorService::class,
            'App\Interfaces\Product\InventoryServiceInterface' => \App\Services\Product\InventoryService::class,
            'App\Interfaces\Product\ProductCategoryServiceInterface' => \App\Services\Product\ProductCategoryService::class,
            'App\Interfaces\Product\ProductServiceInterface' => \App\Services\Product\ProductService::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\openaxis\public\storage' => 'string',
...
'app.admin_password','app.admin_first_name','app.admin_last_name','app','app.Agent',
...
'database.redis.cache.backoff_cap','debugbar.enabled','debugbar.hide_empty_tabs','debugbar.except','debugbar.storage.enabled',
...
'filesystems.disks.media.root','filesystems.disks.media.url','filesystems.disks.media.visibility','filesystems.disks.media.throw','filesystems.links.C:\\xampp\\htdocs\\openaxis\\public\\storage',
...
'reverb.apps.apps.0.activity_timeout','reverb.apps.apps.0.max_connections','reverb.apps.apps.0.max_message_size','services.postmark.key','services.resend.key',
...
'profile.edit','profile.update','profile.destroy','profile.notifications','profile.notifications.toggle-read',
'profile.notifications.destroy','profile.addresses','profile.addresses.store','profile.addresses.update','profile.addresses.set-primary',
'profile.addresses.destroy','user-password.edit','user-password.update','appearance.edit','two-factor.show',
'sessions.index','sessions.destroy','administrative.roles.index','administrative.roles.create','administrative.roles.store',
'administrative.roles.show','administrative.roles.edit','administrative.roles.update','administrative.roles.destroy','administrative.users.force-destroy',
'administrative.users.index','administrative.users.create','administrative.users.store','administrative.users.show','administrative.users.edit',
'administrative.users.update','administrative.users.destroy','administrative.notifier.create','administrative.notifier.notify','administrative.mailable.new-account',
'erp.categories.index','erp.categories.create','erp.categories.store','erp.categories.edit','erp.categories.update',
'erp.categories.destroy','erp.products.force-destroy','erp.products.index','erp.products.create','erp.products.store',
'erp.products.show','erp.products.edit','erp.products.update','erp.products.destroy','erp.inventory.index',
'erp.inventory.create','erp.inventory.store','erp.inventory.show','erp.inventory.edit','erp.inventory.update',
'erp.inventory.destroy','erp.clients.force-destroy','erp.clients.index','erp.clients.create','erp.clients.store',
'erp.clients.show','erp.clients.edit','erp.clients.update','erp.clients.destroy','erp.purchase-orders.index',
'erp.purchase-orders.create','erp.purchase-orders.store','erp.purchase-orders.edit','erp.purchase-orders.update','erp.purchase-orders.destroy',
'erp.sales-orders.index','erp.sales-orders.create','erp.sales-orders.store','erp.sales-orders.edit','erp.sales-orders.update',
'erp.sales-orders.destroy','erp.vendors.force-destroy','erp.vendors.index','erp.vendors.create','erp.vendors.store',
'erp.vendors.show','erp.vendors.edit','erp.vendors.update','erp.vendors.destroy','erp.suppliers.force-destroy',
'erp.suppliers.index','erp.suppliers.create','erp.suppliers.store','erp.suppliers.show','erp.suppliers.edit',
'erp.suppliers.update','erp.suppliers.destroy','erp.payables.index','erp.payables.create','erp.payables.store',
'erp.payables.show','erp.payables.edit','erp.payables.update','erp.payables.destroy','erp.receivables.index',
'erp.receivables.create','erp.receivables.store','erp.receivables.show','erp.receivables.edit','erp.receivables.update',
'erp.receivables.destroy','erp.payment-conditions.index','erp.payment-conditions.create','erp.payment-conditions.store','erp.payment-conditions.edit',
'erp.payment-conditions.update','erp.payment-conditions.destroy','storage.local',);
...
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.xampp.htdocs.openaxis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'APP_ADMIN_EMAIL','APP_ADMIN_NAME','APP_ADMIN_PASSWORD','APP_TIMEZONE','APP_LOCALE',
'APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER','PHP_CLI_SERVER_WORKERS','HASH_DRIVER',
'ARGON_MEMORY','ARGON_THREADS','ARGON_TIME','HASH_VERIFY','LOG_CHANNEL',
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','BROADCAST_CONNECTION','REVERB_APP_ID','REVERB_APP_KEY',
'REVERB_APP_SECRET','REVERB_HOST','REVERB_PORT','REVERB_SCHEME','VITE_REVERB_APP_KEY',
'VITE_REVERB_HOST','VITE_REVERB_PORT','VITE_REVERB_SCHEME','DEBUGBAR_ENABLED',);
