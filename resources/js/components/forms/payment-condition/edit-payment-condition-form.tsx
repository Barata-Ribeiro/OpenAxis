...
interface EditPaymentConditionFormProps {
                    ...
                    <FieldGroup className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <Field aria-invalid={!!errors.code}>
                            ...
                            <InputGroup>
                                <InputGroupInput
                                    ...
                                    defaultValue={paymentCondition.code}
                                    maxLength={20}
                                    required
                                    aria-required
                        ...
                        <Field aria-invalid={!!errors.name}>
                            ...
                            <Input
                                ...
                                defaultValue={paymentCondition.name}
                                maxLength={100}
                                required
                                aria-required
                    ...
                    <FieldGroup className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <Field aria-invalid={!!errors.days_until_due}>
                            ...
                            <Input
                                ...
                                name="days_until_due"
                                placeholder="e.g. 30"
                                defaultValue={paymentCondition.days_until_due}
                                min={0}
                                required
                                aria-required
                        ...
                        <Field aria-invalid={!!errors.installments}>
                            ...
                            <InputGroup>
                                <InputGroupInput
                                    ...
                                    name="installments"
                                    placeholder="e.g. 1"
                                    defaultValue={paymentCondition.installments}
                                    min={1}
                                    required
                                    aria-required
                    ...
                    <Field data-invalid={!!errors.is_active}>
                        <div className="flex items-center space-x-3">
                            <Checkbox
                                id="is_active"
                                name="is_active"
                                defaultChecked={paymentCondition.is_active}
