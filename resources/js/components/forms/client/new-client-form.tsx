            ...
            {({ processing, resetAndClearErrors, errors }) => (
                <>
                    <FieldSet>
                        ...
                        <FieldDescription>Please provide the client's information below.</FieldDescription>
                        ...
                        <Field data-invalid={!!errors.client_type}>
                            ...
                            <Select name="client_type" required aria-required>
                    ...
                    <FieldSet>
                        ...
                        <FieldDescription>Please provide the client's address information below.</FieldDescription>
