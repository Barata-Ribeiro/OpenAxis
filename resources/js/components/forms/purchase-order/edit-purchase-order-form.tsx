...
export default function EditPurchaseOrderForm({ purchaseOrder }: Readonly<EditPurchaseOrderFormProps>) {
    const [supplierId, setSupplierId] = useState<number | null>(purchaseOrder.supplier_id);
    const [orderDate, setOrderDate] = useState<Date | null>(new Date(purchaseOrder.order_date));
    const [forecastDate, setForecastDate] = useState<Date | null>(new Date(purchaseOrder.forecast_date));
    return (
        <Form
            {...erp.purchaseOrders.update.form(purchaseOrder.id)}
            ...
            {({ processing, errors }) => (
                <>
                    ...
                    <Field data-invalid={!!errors.status}>
                        ...
                        <Select name="status" defaultValue={purchaseOrder.status} required aria-required>
                    ...
                    <Field aria-invalid={!!errors.notes}>
                        ...
                        <Textarea id="notes" name="notes" rows={4} defaultValue={purchaseOrder.notes ?? ''} />
